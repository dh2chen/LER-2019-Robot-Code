...
/**
 *
 * @author Lake Effect Robotics
 * 
 * Based on Simbotics SimPID.  Thanks!
 */
public class LER_PID {

    double m_p;
    double m_i;
    double m_d;

    double m_errorEpsilon;
    double m_desiredValue;
    boolean m_firstCycle;
    double m_maxOutput;
    double m_minOutput;
    double m_deadBand;
    double m_errorIncrement;

    double m_cycleCount;
    double m_minCycleCount;

    double m_previousValue, m_errorSum;

    /**
     * Initializes the KbotPID object. All parameters default to 0.
     */
    public LER_PID(double p, double i, double d, double epsilon) {
        m_p = p;
        m_i = i;
        m_d = d;
        m_errorSum = 0.0;
     ...
     * calculation. This defaults to 1 in the constructor, which has worked well
     */
    ...
    /**
     * Sets the ceiling for the output of the calculation. This defaults to 1.0
     * (full output). Values should be between 0.0 and 1.0.
     */
    ...
    /**
     * Sets the floor for the output of the calculation. This defaults to -1.0
     * (full output). Values should be between -1.0 and 0.0.
     */
    ...
    /**
     * Sets the deadband for the output calculation. This defaults to 0.0 (no
     * deadband). Values must be between -1.0 and 1.0 (likely between -0.2 amd
     * 0.2).
     */
    ...
    /**
     * Calculates the PID output based on the current value. PID constants and
     * desired value should be set before calling this function.
     */
